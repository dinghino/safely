  ...
  return (
    <div className="flex flex-col gap-4 rounded-lg border bg-card p-4 text-card-foreground shadow-sm lg:flex-row">
      <div className="flex-1 space-y-1.5">
        <Label htmlFor="category-filter" className="px-1 text-muted-foreground text-xs uppercase tracking-wider">
          Categories
        </Label>
      ...
      <div className="flex-1 space-y-1.5">
        <Label htmlFor="search-filter" className="px-1 text-muted-foreground text-xs uppercase tracking-wider">
          Search
        </Label>
