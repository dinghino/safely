...
export function isNotEmptyArray<T>(arr: T[] | undefined): arr is [T, ...T[]] {
  return !!arr && arr.length > 0
}
export function hasOneItem<T>(arr: T[] | undefined): arr is [T] {
  return !!arr && arr.length === 1
}

export function hasTwoItems<T>(arr: T[] | undefined): arr is [T, T] {
